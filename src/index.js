...
var Message = React.createClass({
  render: function() {
    return (
      <p className={this.props.who}><img src={require('../public/assets/' + this.props.who + '.png')} /> "{this.props.text}"</p>
    )
  }
});
    ...
    return (
      <div className="store">
        ...
        <div className="orders">
          <div><img src={require('../public/assets/order-confirmed.png')}/> {this.getCount("Confirmed")}</div>
          <div><img src={require('../public/assets/order-oven.png')}/> {this.getCount("In The Oven")}</div>
          <div><img src={require('../public/assets/order-delivered.png')}/> {this.getCount("Delivered")}</div>
        </div>
      </div>
    )
  }
